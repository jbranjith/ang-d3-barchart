...
import { ISalesData } from '../../../app/shared/model/sales-data.model';
import { AppConst } from '../../../app/shared/app-constants';
...
export class BarChartV1Component implements OnInit {
  ...
  private generateBarChart(data: ISalesData[]): void {
    ...
    this.svg.append('g').call(d3.axisRight(this.yScale).tickValues([maxYdata]));
